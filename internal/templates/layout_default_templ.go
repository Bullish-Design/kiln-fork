...
func DefaultLayout(data *PageData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "</div></div></header><div class=\"p-6 flex-1 overflow-y-auto flex flex-col gap-2\"><div class=\"relative\"><input type=\"text\" id=\"navbar-search\" placeholder=\"Search notes...\" class=\"w-full p-2 rounded border border-sidebar-border text-sm\"></div><ul class=\"font-main text-sm\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
